...
class driver_mysql {
	...
	function connect($dbhost, $dbuser, $dbpw, $dbname = '', $dbcharset, $pconnect = 0, $tablepre='') {
	...
	function query($sql, $silent = false, $unbuffered = false) {
		...
		if(!($query = $func($sql, $this->link)) && !$silent) {
	...
	function halt($message = '', $sql = '') {
		echo '<h2>',$message,'</h2><p><b>SQL:</b>',$sql,'</p><p><b>Error:</b>',mysql_error(),'</p>';
		exit;
	}
}
